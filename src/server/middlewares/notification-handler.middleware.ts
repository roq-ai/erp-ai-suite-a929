...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'log_analysis.create': {
    ...
    key: 'log-analysis-created',
    tenantPath: ['organization', 'log_analysis'],
    userPath: [],
  },
  'performance_optimization.update': {
    roles: ['system-administrator', 'data-analyst'],
    key: 'performance-optimization-updated',
    tenantPath: ['organization', 'performance_optimization'],
    userPath: [],
  },
  'security_assessment.delete': {
    roles: ['system-administrator', 'security-officer'],
    key: 'security-assessment-deleted',
    tenantPath: ['organization', 'security_assessment'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['system-administrator', 'data-analyst', 'security-officer'];
