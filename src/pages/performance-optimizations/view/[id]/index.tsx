...
import { getPerformanceOptimizationById } from 'apiSdk/performance-optimizations';
import { PerformanceOptimizationInterface } from 'interfaces/performance-optimization';

function PerformanceOptimizationViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Performance Optimization Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('performance_optimization', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/performance-optimizations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={
                    data?.optimization_date
                      ? format(parseISO(data?.optimization_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Optimization Details" text={data?.optimization_details} />
...
)(PerformanceOptimizationViewPage);
