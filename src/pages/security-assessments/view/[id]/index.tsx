...
import { getSecurityAssessmentById } from 'apiSdk/security-assessments';
import { SecurityAssessmentInterface } from 'interfaces/security-assessment';

function SecurityAssessmentViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Security Assessment Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('security_assessment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/security-assessments/edit/${id}`} passHref legacyBehavior>
                    <Button
