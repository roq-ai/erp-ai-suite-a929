...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: [
          'user',
          'data_privacy_assessment.count',
          'log_analysis.count',
          'performance_optimization.count',
          'security_assessment.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('data_privacy_assessment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'data_privacy_assessment',
          header: 'Data Privacy Assessment',
          accessorKey: 'data_privacy_assessment',
          cell: ({ row: { original: record } }: any) => record?._count?.data_privacy_assessment,
        }
      : null,
    hasAccess('log_analysis', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'log_analysis',
          header: 'Log Analysis',
          accessorKey: 'log_analysis',
          cell: ({ row: { original: record } }: any) => record?._count?.log_analysis,
        }
      : null,
    hasAccess('performance_optimization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'performance_optimization',
          header: 'Performance Optimization',
          accessorKey: 'performance_optimization',
          cell: ({ row: { original: record } }: any) => record?._count?.performance_optimization,
        }
      : null,
    hasAccess('security_assessment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'security_assessment',
          header: 'Security Assessment',
          accessorKey: 'security_assessment',
          cell: ({ row: { original: record } }: any) => record?._count?.security_assessment,
        }
      : null,
